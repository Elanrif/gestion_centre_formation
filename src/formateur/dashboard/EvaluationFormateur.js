...
function createData(qualitepeda,rythme,supportcourstp,maitrisesujet,remarque,note,utilisateur) {
  //const density = population / size;
  return {qualitepeda,rythme,supportcourstp,maitrisesujet,remarque,note,utilisateur};
}
