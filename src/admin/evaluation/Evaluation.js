...
function createData(qualitepeda,rythme,supportcourstp,maitrisesujet,remarque,note,utilisateur,formateur,options) {
  //const density = population / size;
  return {qualitepeda,rythme,supportcourstp,maitrisesujet,remarque,note,utilisateur,formateur,options};
}
...
export default function Evaluation() {
 ...
 const btnOptions = (data)=> (
    <div className='flex justify-center items-center space-x-[-5px]'>
                     <DeleteEvaluation value ={{data,handleSetUpdate}}/>
                  </div>
) 
